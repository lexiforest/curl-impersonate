...
* `curl-impersonate` connects to the same HTTP/3 endpoint through a local SOCKS5 UDP proxy. Both local (`socks5`) and proxy-side (`socks5h`) DNS resolution are tested.
